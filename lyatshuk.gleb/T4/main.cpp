...
а
[A[A[A[B[C[A[A[A[B[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[C[Ccat lyatshuk.gleb/T4/main.cpp
...
[A[A[A[A[A[A[A[A[A[A[A[A[A[C[C[C[C[C[C[B[B[B[B[B[B[Bcat > lyatshuk.gleb/T4/main.cpp << 'EOF'
#include <iostream>
#include <iomanip>
#include <memory>
#include <vector>
