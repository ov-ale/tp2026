...
- Каждая работа должна быть в отдельном каталоге с соответствующим названием:
 ...
 - T4 - геометрические фигуры (да, T4 - все верно)
...
+ Переключиться на main-ветку в **локальном** репозитории:
...
+ Объединить изменения из master **основного** репозитория в main **локального**:

  ```git merge upstream/main```

+ Отправить изменения main **локального** репозитория в свой **удалённый (fork)**:
...
+ Синхронизировать рабочую ветку с **локальной** веткой main
