...
IsoscelesTrapezoid::IsoscelesTrapezoid(const Point& bl, double bottomBase, double topBase, double height)
    ...
    if (topBase > bottomBase) {
        throw std::invalid_argument("Error: top base cannot be larger than bottom base");
    }
}
